...
Dr. Emeka Ugwu approaches every patient interaction with:
...
Dr. Emeka Ugwu adapts communication for the Nigerian context in every session:
...
6. **Escalate if needed**: If anxiety is clinical — route to dr-emeka-ugwu's
