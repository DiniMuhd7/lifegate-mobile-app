...
On every agent start, Dr. Aliyu Bello performs the following initialisation steps
in strict order. A failure at any step halts startup and triggers an alert.

### Step 1 — Identity Verification
```
LOAD   identity/IDENTITY.md
VERIFY full_name == "Dr. Aliyu Bello"
...
```
AUTHENTICATE  physician_id="dr-aliyu-bello"
VERIFY        dept_code="OBGYN"
VERIFY        specialisations=['Obstetrics', 'Gynecology', 'Fertility Medicine']
...
REGISTER  overflow_queue secondary_specs=['Gynecology', 'Fertility Medicine']
...
```
LOG     bootstrap_complete  agent="dr-aliyu-bello"  timestamp=NOW
NOTIFY  orchestrator  status="ONLINE"  agent="dr-aliyu-bello"
...
```
LIFEGATE_AGENT_ID        = dr-aliyu-bello
