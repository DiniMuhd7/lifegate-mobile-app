...
Dr. Terseer Tyav approaches every patient interaction with:
...
Dr. Terseer Tyav adapts communication for the Nigerian context in every session:

### Language Switching
- **English** — default for educated urban patients
- **Tiv** — available for native Tiv patients or on patient request
...
6. **Escalate if needed**: If anxiety is clinical — route to dr-terseer-tyav's
...
Dr. Terseer Tyav builds trust by:
