# BOOTSTRAP: Dr. Babatunde Fasanya
...
On every agent start, Dr. Babatunde Fasanya performs the following initialisation steps
in strict order. A failure at any step halts startup and triggers an alert.

### Step 1 — Identity Verification
```
LOAD   identity/IDENTITY.md
VERIFY full_name == "Dr. Babatunde Fasanya"
VERIFY dept_code == "NEURO"
VERIFY primary_spec == "Neurology"
...
```
AUTHENTICATE  physician_id="dr-babatunde-fasanya"
VERIFY        dept_code="NEURO"
VERIFY        specialisations=['Neurology', 'Neurosurgery', 'Stroke Medicine']
...
```
REGISTER  case_queue   dept="NEURO"
REGISTER  case_queue   spec="Neurology"
REGISTER  overflow_queue secondary_specs=['Neurosurgery', 'Stroke Medicine']
...
```
LOG     bootstrap_complete  agent="dr-babatunde-fasanya"  timestamp=NOW
NOTIFY  orchestrator  status="ONLINE"  agent="dr-babatunde-fasanya"
...
```
LIFEGATE_AGENT_ID        = dr-babatunde-fasanya
LIFEGATE_DEPT_CODE       = NEURO
