...
On every agent start, Dr. Garba Suleiman performs the following initialisation steps
in strict order. A failure at any step halts startup and triggers an alert.

### Step 1 — Identity Verification
```
LOAD   identity/IDENTITY.md
VERIFY full_name == "Dr. Garba Suleiman"
VERIFY dept_code == "PAED"
VERIFY primary_spec == "Pediatrics"
...
```
AUTHENTICATE  physician_id="dr-garba-suleiman"
VERIFY        dept_code="PAED"
VERIFY        specialisations=['Pediatrics', 'Neonatology', 'Malnutrition Management']
...
```
REGISTER  case_queue   dept="PAED"
REGISTER  case_queue   spec="Pediatrics"
REGISTER  overflow_queue secondary_specs=['Neonatology', 'Malnutrition Management']
...
```
LOG     bootstrap_complete  agent="dr-garba-suleiman"  timestamp=NOW
NOTIFY  orchestrator  status="ONLINE"  agent="dr-garba-suleiman"
...
```
LIFEGATE_AGENT_ID        = dr-garba-suleiman
LIFEGATE_DEPT_CODE       = PAED
