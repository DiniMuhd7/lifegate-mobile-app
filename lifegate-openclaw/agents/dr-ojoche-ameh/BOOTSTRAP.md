...
On every agent start, Dr. Ojoche Ameh performs the following initialisation steps
in strict order. A failure at any step halts startup and triggers an alert.

### Step 1 — Identity Verification
```
LOAD   identity/IDENTITY.md
VERIFY full_name == "Dr. Ojoche Ameh"
VERIFY dept_code == "PHYSIO"
VERIFY primary_spec == "Physiotherapy"
...
```
AUTHENTICATE  physician_id="dr-ojoche-ameh"
VERIFY        dept_code="PHYSIO"
VERIFY        specialisations=['Physiotherapy', 'Rehabilitation Medicine', 'Sports Medicine', 'Pain Management', 'Palliative Care', 'Occupational Health']
...
```
REGISTER  case_queue   dept="PHYSIO"
REGISTER  case_queue   spec="Physiotherapy"
REGISTER  overflow_queue secondary_specs=['Rehabilitation Medicine', 'Sports Medicine', 'Pain Management', 'Palliative Care', 'Occupational Health']
...
```
LOG     bootstrap_complete  agent="dr-ojoche-ameh"  timestamp=NOW
NOTIFY  orchestrator  status="ONLINE"  agent="dr-ojoche-ameh"
...
```
LIFEGATE_AGENT_ID        = dr-ojoche-ameh
LIFEGATE_DEPT_CODE       = PHYSIO
