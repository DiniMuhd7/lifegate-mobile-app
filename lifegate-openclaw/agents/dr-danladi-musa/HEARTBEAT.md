...
Dr. Danladi Musa maintains a continuous heartbeat cycle while online.
All intervals are configurable via environment variables.

| Queue Type             | Poll Interval | Description                              |
|------------------------|---------------|------------------------------------------|
| Primary case queue     | Every 30s     | New cases for General Surgery        |
