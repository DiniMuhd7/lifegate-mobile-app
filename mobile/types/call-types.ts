...
export interface ActiveCall {
  ...
  diagnosisId: string;
  /**
   * The caller's SDP offer, carried from IncomingCall into ActiveCall when
   * the callee accepts.  Used by VoiceCallScreen / VideoCallScreen to send the
   * WebRTC answer without having to re-read the now-cleared incomingCall slot.
   */
  calleeSdpOffer?: string;
