  ...
  acceptIncomingCall: () => {
    ...
    set({
      activeCall: {
        ...
        // Carry the SDP offer forward so the call screen can build the answer
        // after incomingCall is cleared.  Without this the callee WebView
        // receives `data: undefined` and the peer connection never completes.
        calleeSdpOffer: incomingCall.sdpOffer,
      },
      incomingCall: null,
      pendingIceCandidates: [],
      pendingSdpAnswer: null,
