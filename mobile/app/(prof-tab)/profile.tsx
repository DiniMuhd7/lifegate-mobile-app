...
export default function PhysicianProfileScreen() {
  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
                ...
                <>
                  <View className="mt-3 flex-row items-center gap-2 rounded-md bg-teal-50 p-2">
                    ...
                    <Text className="flex-1 text-xs text-teal-700">
                      AI mode is active. Cases will be handled automatically using your persona.
                    </Text>
                  </View>

                  {/* Workspace editor entry point */}
                  <TouchableOpacity
                  ...
                  >
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <Text style={{ fontSize: 11, color: '#0d9488', marginTop: 1 }}>
                        Personalise your AI identity, communication style &amp; persona
                      </Text>
                    </View>
      ...
      {/* AI Workspace Editor — only mounted when AI mode is on */}
      {aiModeEnabled && (
