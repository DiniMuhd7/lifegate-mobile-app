              ...
              <View style={{ gap: 8 }}>
                {d.description
                  ...
                  .map((line, i) => {
                      ...
                      return (
                        <View key={i} style={{ flexDirection: 'row', gap: 10, alignItems: 'flex-start' }}>
                          <View style={{
                            ...
                            <Text style={{ fontSize: 10, fontWeight: '800', color: '#0AADA2' }}>{i + 1}</Text>
                          </View>
                          <View style={{ flex: 1 }}>
                            <Text style={{ fontSize: 13, lineHeight: 20, color: '#1e293b' }}>
                    ...
                    return (
                      <Text key={i} style={{ fontSize: 13, color: '#475569', lineHeight: 20 }}>
                        {line}
                      </Text>
                    );
                  })}
