...
var CategoryPromptSnippets = map[string]string{
	"doctor_consultation": "Specialized focus: Help the user prepare for a medical consultation. Clarify when a doctor visit is necessary, how to describe symptoms effectively, what questions to ask, and what information to bring. Emphasize the importance of professional diagnosis. Do NOT include prescriptions.",
	...
	"eye_checkup":         "Specialized focus: Provide guidance on eye health. Cover common visual symptoms (blurred vision, eye pain, floaters, redness), when to see an ophthalmologist, what an eye examination involves, and tips for maintaining good eye health. Do NOT include prescriptions.",
	"hearing_test":        "Specialized focus: Provide guidance on hearing health. Cover signs of hearing loss, tinnitus, what an audiometry test involves, when to consult an audiologist, and hearing protection tips. Do NOT include prescriptions.",
