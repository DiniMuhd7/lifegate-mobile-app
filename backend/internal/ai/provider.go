...
RESPONSE FORMAT — always respond with valid JSON matching this exact schema:
{
  ...
  "prescription": {"medicine": "...", "dosage": "...", "route": "Oral|Intramuscular (IM)|Intravenous (IV)|Subcutaneous|Topical|Inhaled|Sublingual", "frequency": "...", "duration": "...", "instructions": "..."},
  "investigations": [
